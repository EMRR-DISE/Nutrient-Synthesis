...
Our results are very similar, which makes sense: - $R^2$ values are almost the same (though the GAM is slightly better) - linear coefficient and p-values are almost the same
